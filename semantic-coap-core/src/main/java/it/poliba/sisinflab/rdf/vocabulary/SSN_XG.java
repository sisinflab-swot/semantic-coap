...
public class SSN_XG {
	...
	static {
		Accuracy = IRI.create(SSN_XG.NAMESPACE, "#Accuracy");
		attachedSystem = IRI.create(SSN_XG.NAMESPACE, "#attachedSystem");
		BatteryLifetime = IRI.create(SSN_XG.NAMESPACE, "#BatteryLifetime");
		Condition = IRI.create(SSN_XG.NAMESPACE, "#Condition");
		deployedOnPlatform = IRI.create(SSN_XG.NAMESPACE, "#deployedOnPlatform");
		deployedSystem = IRI.create(SSN_XG.NAMESPACE, "#deployedSystem");
		Deployment = IRI.create(SSN_XG.NAMESPACE, "#Deployment");
		deploymentProcessPart = IRI.create(SSN_XG.NAMESPACE, "#deploymentProcessPart");
		DeploymentRelatedProcess = IRI.create(SSN_XG.NAMESPACE, "#DeploymentRelatedProcess");
		DetectionLimit = IRI.create(SSN_XG.NAMESPACE, "#DetectionLimit");
		detects = IRI.create(SSN_XG.NAMESPACE, "#detects");
		Device = IRI.create(SSN_XG.NAMESPACE, "#Device");
		Drift = IRI.create(SSN_XG.NAMESPACE, "#Drift");
		endTime = IRI.create(SSN_XG.NAMESPACE, "#endTime");
		featureOfInterest = IRI.create(SSN_XG.NAMESPACE, "#featureOfInterest");
		FeatureOfInterest = IRI.create(SSN_XG.NAMESPACE, "#FeatureOfInterest");
		forProperty = IRI.create(SSN_XG.NAMESPACE, "#forProperty");
		Frequency = IRI.create(SSN_XG.NAMESPACE, "#Frequency");
		hasDeployment = IRI.create(SSN_XG.NAMESPACE, "#hasDeployment");
		hasInput = IRI.create(SSN_XG.NAMESPACE, "#hasInput");
		hasMeasurementCapability = IRI.create(SSN_XG.NAMESPACE, "#hasMeasurementCapability");
		hasMeasurementProperty = IRI.create(SSN_XG.NAMESPACE, "#hasMeasurementProperty");
		hasOperatingProperty = IRI.create(SSN_XG.NAMESPACE, "#hasOperatingProperty");
		hasOperatingRange = IRI.create(SSN_XG.NAMESPACE, "#hasOperatingRange");
		hasOutput = IRI.create(SSN_XG.NAMESPACE, "#hasOutput");
		hasProperty = IRI.create(SSN_XG.NAMESPACE, "#hasProperty");
		hasSubSystem = IRI.create(SSN_XG.NAMESPACE, "#hasSubSystem");
		hasSurvivalProperty = IRI.create(SSN_XG.NAMESPACE, "#hasSurvivalProperty");
		hasSurvivalRange = IRI.create(SSN_XG.NAMESPACE, "#hasSurvivalRange");
		hasValue = IRI.create(SSN_XG.NAMESPACE, "#hasValue");
		implementedBy = IRI.create(SSN_XG.NAMESPACE, "#implementedBy");
		_implements = IRI.create(SSN_XG.NAMESPACE, "#implements");
		inCondition = IRI.create(SSN_XG.NAMESPACE, "#inCondition");
		inDeployment = IRI.create(SSN_XG.NAMESPACE, "#inDeployment");
		Input = IRI.create(SSN_XG.NAMESPACE, "#Input");
		isProducedBy = IRI.create(SSN_XG.NAMESPACE, "#isProducedBy");
		isPropertyOf = IRI.create(SSN_XG.NAMESPACE, "#isPropertyOf");
		isProxyFor = IRI.create(SSN_XG.NAMESPACE, "#isProxyFor");
		Latency = IRI.create(SSN_XG.NAMESPACE, "#Latency");
		madeObservation = IRI.create(SSN_XG.NAMESPACE, "#madeObservation");
		MaintenanceSchedule = IRI.create(SSN_XG.NAMESPACE, "#MaintenanceSchedule");
		MeasurementCapability = IRI.create(SSN_XG.NAMESPACE, "#MeasurementCapability");
		MeasurementProperty = IRI.create(SSN_XG.NAMESPACE, "#MeasurementProperty");
		MeasurementRange = IRI.create(SSN_XG.NAMESPACE, "#MeasurementRange");
		Observation = IRI.create(SSN_XG.NAMESPACE, "#Observation");
		observationResult = IRI.create(SSN_XG.NAMESPACE, "#observationResult");
		observationResultTime = IRI.create(SSN_XG.NAMESPACE, "#observationResultTime");
		observationSamplingTime = IRI.create(SSN_XG.NAMESPACE, "#observationSamplingTime");
		ObservationValue = IRI.create(SSN_XG.NAMESPACE, "#ObservationValue");
		observedBy = IRI.create(SSN_XG.NAMESPACE, "#observedBy");
		observedProperty = IRI.create(SSN_XG.NAMESPACE, "#observedProperty");
		observes = IRI.create(SSN_XG.NAMESPACE, "#observes");
		ofFeature = IRI.create(SSN_XG.NAMESPACE, "#ofFeature");
		onPlatform = IRI.create(SSN_XG.NAMESPACE, "#onPlatform");
		OperatingPowerRange = IRI.create(SSN_XG.NAMESPACE, "#OperatingPowerRange");
		OperatingProperty = IRI.create(SSN_XG.NAMESPACE, "#OperatingProperty");
		OperatingRange = IRI.create(SSN_XG.NAMESPACE, "#OperatingRange");
		Output = IRI.create(SSN_XG.NAMESPACE, "#Output");
		Platform = IRI.create(SSN_XG.NAMESPACE, "#Platform");
		Precision = IRI.create(SSN_XG.NAMESPACE, "#Precision");
		Process = IRI.create(SSN_XG.NAMESPACE, "#Process");
		Property = IRI.create(SSN_XG.NAMESPACE, "#Property");
		qualityOfObservation = IRI.create(SSN_XG.NAMESPACE, "#qualityOfObservation");
		Resolution = IRI.create(SSN_XG.NAMESPACE, "#Resolution");
		ResponseTime = IRI.create(SSN_XG.NAMESPACE, "#ResponseTime");
		Selectivity = IRI.create(SSN_XG.NAMESPACE, "#Selectivity");
		Sensing = IRI.create(SSN_XG.NAMESPACE, "#Sensing");
		SensingDevice = IRI.create(SSN_XG.NAMESPACE, "#SensingDevice");
		sensingMethodUsed = IRI.create(SSN_XG.NAMESPACE, "#sensingMethodUsed");
		Sensitivity = IRI.create(SSN_XG.NAMESPACE, "#Sensitivity");
		Sensor = IRI.create(SSN_XG.NAMESPACE, "#Sensor");
		SensorDataSheet = IRI.create(SSN_XG.NAMESPACE, "#SensorDataSheet");
		SensorInput = IRI.create(SSN_XG.NAMESPACE, "#SensorInput");
		SensorOutput = IRI.create(SSN_XG.NAMESPACE, "#SensorOutput");
		startTime = IRI.create(SSN_XG.NAMESPACE, "#startTime");
		Stimulus = IRI.create(SSN_XG.NAMESPACE, "#Stimulus");
		SurvivalProperty = IRI.create(SSN_XG.NAMESPACE, "#SurvivalProperty");
		SurvivalRange = IRI.create(SSN_XG.NAMESPACE, "#SurvivalRange");
		System = IRI.create(SSN_XG.NAMESPACE, "#System");
		SystemLifetime = IRI.create(SSN_XG.NAMESPACE, "#SystemLifetime");
	}

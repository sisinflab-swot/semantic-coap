...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String lat = getIntent().getExtras().getString(SemanticLinkFormat.LATITUDE);
        String lon = getIntent().getExtras().getString(SemanticLinkFormat.LONGITUDE);
        String title = getIntent().getExtras().getString(LinkFormat.TITLE);
